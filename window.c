...
static GL4DHanime _animations[] = {
  { 14650, point, NULL, NULL },
  { 2000, point, rectangle, fondu },
  { 25000, rectangle, NULL, NULL }, 
  { 500, rectangle, rainbow, fondu },
  { 28500, rainbow, NULL, NULL },
  { 500, rainbow, music_fft, fondui },
  { 29000, music_fft, NULL, NULL },
  { 1000, music_fft, voronoi, fondu },
  { 42000, voronoi, NULL, NULL },
  { 500, voronoi, coloration, fondui },
  { 26500, coloration, NULL, NULL },
  { 2000, coloration, music_simple, fondui }, 
  { 28000, music_simple, NULL, NULL },
...
int main(int argc, char ** argv) {
  if(!gl4duwCreateWindow(argc, argv, "Motamed Amin", 
			 0, 0, 
			 _dim[0], _dim[1],
  ...
  ahInitAudio("audio/Giraffe Squad - Wait for me.mp3");
  gl4duwMainLoop();
  return 0;
}
